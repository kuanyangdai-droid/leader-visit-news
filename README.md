...
```json
{
  ...
  "leader_title": "职务",
  "country": "国家或地区",
  "origin": "新闻中明确出现的启程地；缺失时可回退为所属国首都",
  "origin_inferred": "是否为根据领导人所属国首都推测的启程地",
...
页面会重点展示“领导人所属国家”和 `FROM → TO` 路线。新闻没有明确写出启程地时，系统会根据领导人所属国回退到首都，并清楚标注“推测：所属国首都出发”；目的地没有公开信息时仍显示“未确认”。
